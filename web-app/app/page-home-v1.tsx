      ...
      <div className="menu-mobile-popup">
        ...
        <div className="widget-filter">
          <div className="mobile-header">
            ...
            <button className="title-button-group" onClick={handleMobile} style={{ border: 'none', background: 'none', cursor: 'pointer', padding: 0 }}>
                      ...
                      <li className="menu-item menu-item-has-children-mobile">
                        ...
                        <Collapse isOpened={toggle.key === "job"}>
                          ...
                          >
                            ...
                            <li className="menu-item menu-item-mobile">
                              <Link href="/job-grid">Grid Layout</Link>
                            </li>
                            <li className="menu-item menu-item-mobile">
