        ...
        <div className="row wow fadeInUp">
                  ...
                  <div className="inner-box">
                    <div className="logo-company">
                      {idx.img
                        ...
                        : <div style={{width:'54px',height:'54px',borderRadius:'8px',background:'#eef2ff',color:'#4f46e5',display:'flex',alignItems:'center',justifyContent:'center',fontSize:'22px',fontWeight:700}}>{(idx.cate||'?')[0]?.toUpperCase()}</div>
                      }
                    </div>
                ...
                <div className="job-archive-footer">
                  <div className="job-footer-left">
                    <ul className="job-tag">
                      <li>
                        <Link href="#">{idx.jobs1}</Link>
                      </li>
                      <li>
                        <Link href="#">{idx.jobs2}</Link>
                      </li>
                    </ul>
                    <div className="star">
          ...
          <div className="col-md-12">
            <div className="wrap-button">
              <Button2 title="See more Jobs" link="/find-jobs" />
            </div>
          </div>
        </div>
      </div>
