            ...
            <div className="group-location">
              <div className="box-3">
                <div className="wd-job-location">
                  ...
                  <div className="content">
                    <h6>
                      <Link href="/jobsingle_v1">Canada</Link>
                    </h6>
                ...
                <div className="wd-job-location">
                  ...
                  <div className="content">
                    <h6>
                      <Link href="/jobsingle_v1">Germany</Link>
                    </h6>
                    <Link href="#" className="category">
                      Open Jobs (3)
                    </Link>
              ...
              <div className="box-6">
                <div className="wd-job-location">
                  ...
                  <div className="content">
                    <h6>
                      <Link href="/jobsingle_v1">United States</Link>
                    </h6>
                    <Link href="#" className="category">
                      Open Jobs (3)
                    </Link>
              ...
              <div className="box-3">
                <div className="wd-job-location">
                  ...
                  <div className="content">
                    <h6>
                      <Link href="/jobsingle_v1">United Kingdom</Link>
                    </h6>
                    <Link href="#" className="category">
                      Open Jobs (3)
                    </Link>
                ...
                <div className="wd-job-location">
                  ...
                  <div className="content">
                    <h6>
                      <Link href="/jobsingle_v1">France</Link>
                    </h6>
                    <Link href="#" className="category">
                      Open Jobs (3)
                    </Link>
              ...
              <div className="box-3">
                <div className="wd-job-location">
                  ...
                  <div className="content">
                    <h6>
                      <Link href="/jobsingle_v1">India</Link>
                    </h6>
                    <Link href="#" className="category">
                      Open Jobs (3)
                    </Link>
                ...
                <div className="wd-job-location">
                  ...
                  <div className="content">
                    <h6>
                      <Link href="/jobsingle_v1">Viet Nam</Link>
                    </h6>
                    <Link href="#" className="category">
                      Open Jobs (3)
                    </Link>
