                ...
                <div className="row">
                    <div className="col-lg-3 col-sm-6 wow fadeInUp">
                        <div className="tf-iconbox">
                            ...
                            <h1 className="box-title">
                                <Link href="about-us.html">Reduce Hiring bias</Link>
                            </h1>
                    ...
                    <div className="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">    
                        <div className="tf-iconbox">
                            ...
                            <div className="box-content">
                            <h1 className="box-title">
                                <Link href="about-us.html">Save time & headspace</Link>
                            </h1>
                    ...
                    <div className="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.4s">
                        <div className="tf-iconbox">
                            ...
                            <div className="box-content">
                            <h1 className="box-title">
                                <Link href="about-us.html">Minimize environmental impact</Link>
                            </h1>
